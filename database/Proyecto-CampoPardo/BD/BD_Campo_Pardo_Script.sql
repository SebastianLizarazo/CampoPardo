...
-- Schema bdcampopardo
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `bdcampopardo` DEFAULT CHARACTER SET utf8 ;
USE `bdcampopardo` ;

-- -----------------------------------------------------
-- Table `bdcampopardo`.`Departamento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bdcampopardo`.`Departamento` (
...
-- -----------------------------------------------------
-- Table `bdcampopardo`.`Municipio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bdcampopardo`.`Municipio` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(90) NOT NULL,
  `departamento_id` BIGINT UNSIGNED NOT NULL,
  `acortado` VARCHAR(40) NULL,
  `estado` ENUM('Activo', 'Inactivo') NOT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_Municipio_Depatamentos1_idx` (`departamento_id` ASC),
  CONSTRAINT `fk_Municipio_Depatamentos1`
    FOREIGN KEY (`departamento_id`)
    REFERENCES `bdcampopardo`.`Departamento` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `bdcampopardo`.`Usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bdcampopardo`.`Usuario` (
  `id` TINYINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `Nombres` VARCHAR(45) NOT NULL,
  `Apellidos` VARCHAR(45) NOT NULL,
  `TipoDocumento` ENUM('CC', 'TI') NOT NULL,
  ...
  UNIQUE INDEX `Usuario_UNIQUE` (`Email` ASC),
  ...
  CONSTRAINT `fk_Usuario_Municipio1`
    ...
    REFERENCES `bdcampopardo`.`Municipio` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bdcampopardo`.`Producto` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `Nombre` VARCHAR(45) NOT NULL,
  `Tamano` SMALLINT UNSIGNED NOT NULL,
  `Clasificacion` ENUM('ml', 'Lt', 'gr', 'Kg', 'Lb', 'Oz') NOT NULL,
  `Referencia` VARCHAR(15) NOT NULL,
  `PrecioProduccion` MEDIUMINT UNSIGNED NOT NULL,
  `PrecioVenta` MEDIUMINT UNSIGNED NOT NULL,
  `Presentacion` ENUM('Envase plastico', 'Envase vidrio', 'Predeterminado') NOT NULL,
  ...
  CONSTRAINT `fk_Producto_Usuario1`
    ...
    REFERENCES `bdcampopardo`.`Usuario` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `bdcampopardo`.`Venta`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bdcampopardo`.`Venta` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `Numero` SMALLINT UNSIGNED NOT NULL,
  `FechaVenta` DATE NOT NULL,
  `MedioPago` ENUM('Efectivo', 'Nequi', 'Daviplata') NOT NULL,
  `Estado` ENUM('Pendiente', 'Saldada','Cancelada') NOT NULL,
  `Cliente_id` TINYINT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
...
-- -----------------------------------------------------
-- Table `bdcampopardo`.`DetalleVenta`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bdcampopardo`.`DetalleVenta` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_DetalleVenta_Producto1`
    ...
    REFERENCES `bdcampopardo`.`Producto` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_DetalleVenta_Venta1`
    FOREIGN KEY (`Venta_id`)
    REFERENCES `bdcampopardo`.`Venta` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

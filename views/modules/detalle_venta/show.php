...
require("../../../app/Controllers/DetalleVentasController.php");
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-green">
                            <?php if (!empty($_GET["id"]) && isset($_GET["id"])) {
                                $DataDetalleV = DetalleVentasController::searchForID(["id" => $_GET["id"]]);
                                /* @var $DataDetalleV DetalleVentas */
                                if (!empty($DataDetalleV)) {
                                    ?>
                                    <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-info"></i> &nbsp; Ver Información
                                            del detalle venta numero <?= $DataDetalleV->getId() ?></h3>
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <hr>
                                                    <strong><i class="fas fa-sort-numeric-up-alt"></i>&nbsp;Cantidad producto</strong>
                                                        <p class="text-muted"><?= $DataDetalleV->getCantidadProducto() ?></p>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <a role="button" href="edit.php?id=<?= $DataDetalleV->getId(); ?>"

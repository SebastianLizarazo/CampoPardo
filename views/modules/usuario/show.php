                                ...
                                if (!empty($DataEmpresa)) {
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-10">
                                                <p>
                                                <strong><i class="fas fa-signature"></i>&nbsp; Nombres</strong>
                                                <p class="text-muted"><?= $DataEmpresa->getNombres() ?></p>
                                                <hr>
                                                <strong><i class="fas fa-signature"></i>&nbsp; Apellidos</strong>
                                                <p class="text-muted"><?= $DataEmpresa->getApellidos() ?></p>
                                                <hr>
                                                <strong><i class="fas fa-id-card"></i>&nbsp; TipoDocumento</strong>
                                                <p class="text-muted"><?= $DataEmpresa->getTipoDocumento() ?></p>
                                                <hr>
                                                <strong><i class="fas fa-id-card"></i>&nbsp; NumeroDocumento</strong>
                                                <p class="text-muted"><?= $DataEmpresa->getNumeroDocumento() ?></p>
                                                <hr>
                                                ...
                                                <hr>
                                                <strong><i class="fas fa-directions"></i>&nbsp; Dirección</strong>
                                                ...
                                                <hr>
                                                <strong><i class="fas fa-city"></i>&nbsp; Municipio</strong>
                                                <p class="text-muted"><?= $DataEmpresa->getMunicipioId()->getNombre()?></p>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
